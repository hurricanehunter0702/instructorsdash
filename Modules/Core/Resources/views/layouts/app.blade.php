...
<html lang="{{ app()->getLocale() }}" dir="ltr">
  ...
  <body id="page-top" class="sidebar-toggled">
    ...
    <div id="account_setup_payment_modal" class="modal fade" role="dialog">
      <div class="modal-dialog modal-dialog-centered modal-md">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title">Setup & Configuration Service</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
          </div>
          <form action="{{ route('setup-request.checkout') }}" method="POST">
            @csrf
            <div class="modal-body">
              <p class="mb-4">
                Hire are team to setup and configure your account. This includes setting up your payment gateway. Embed the calendar in to an existing website. Create a sample event and upsell option. Setting up your sms feature.
              </p>          
              <h3 class="text-center mb-3">Amount: <b>$199</b></h3>
    ...
    <script>
      ...
      $(document).ready(function() {
          if (!isAdmin && getCookie('showAfterOneDay') == "") {
