...
<div class="mb-2">
    <div class="row">
        ...
        <div class="col-xl-4 col-lg-4 col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">SMS Fee & Charge Limit</h4>
                </div>
                <div class="card-content">
                    <div class="card-body">
                        <form method="POST" action="{{ route('sms.admin.setting.fee-update') }}">
                            ...
                            <div class="form-group required">
                                <label for="sms_fee">Fee price:</label>
                                <input type="number" required id="sms_fee" step="0.001" name="sms_fee" class="form-control" value="{{ $sms_account->sms_fee }}"/>
                            </div>
                            <div class="form-group required">
                                <label for="sms_charge_limit">Charge limit amount:</label>
                                <input type="number" required id="sms_charge_limit" step="0.1" name="sms_charge_limit" class="form-control" value="{{ $sms_account->sms_charge_limit }}"/>
                            </div>
                            <div class="form-actions text-right">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="enable-sms-hire-form" action="" method="post">
                    ...
                    @method('patch')
                    <div class="modal-body">
                        Do you really want to <b></b> the hire option?
    ...
    $(document).ready(function() {
        ...
        $("#sms-hire-table").on("click", ".enable-sms-hire-btn", function() {
            ...
            if (!isActive) {
                ...
                $("#enable-sms-hire-modal .modal-body b").text("enable");
                $("#enable-sms-hire-modal .modal-footer .btn-primary").html(function() {
                    return `<i class="fa fa-thumbs-up"></i> Enable`
                });
                $("#enable-sms-hire-modal [name='is_active']").val(1);
                $("#enable-sms-hire-modal").modal("show");
            } else {
                $(".enable-sms-hire-form").attr("action", BASE_URL + "/sms/admin/setting/hires/" + id);
                $("#enable-sms-hire-modal .modal-body b").text("disable");
                $("#enable-sms-hire-modal .modal-footer .btn-primary").html(function() {
                    return `<i class="fa fa-thumbs-down"></i> Disable`
                });
                $("#enable-sms-hire-modal [name='is_active']").val(0);
                $("#enable-sms-hire-modal").modal("show");
            }
        });
