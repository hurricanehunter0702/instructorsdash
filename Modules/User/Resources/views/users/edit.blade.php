        ...
        <form role="form" method="post" action="{{ route('settings.users.update', $user) }}">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row" id="row_sms_balance">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">@lang('SMS Funds')</label>
                                <input class="form-control" type="number" value="{{ $user->sms_balance }}" name="sms_balance" />
                            </div>
                        </div>
