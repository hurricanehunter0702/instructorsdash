...
class UserController extends Controller
{
    ...
    public function update(Request $request, User $user)
    {
        ...
        if (!($request->filled('sms_balance'))) {
            $request->request->remove('sms_balance');
        }
    ...
    public function accountSettingsUpdate(Request $request)
    {
        ...
        if ($request->has("user_company_email")) $userData['user_company_email'] = $request->user_company_email;
        if ($request->has("user_company_phone")) $userData['user_company_phone'] = $request->user_company_phone;
        if ($request->has("user_company_website")) $userData['user_company_website'] = $request->user_company_website;
