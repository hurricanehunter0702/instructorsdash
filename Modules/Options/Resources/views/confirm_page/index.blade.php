...
<div class="container">
    ...
    <form action="{{ route('options.confirm-page.store') }}" method="POST">
        ...
        <div class="form-group">
            <textarea class="form-control" name="CONFIRM_PAYMENT_MESSAGE" required placeholder="Please enter your own message" rows="5">{{ config('events.CONFIRM_PAYMENT_MESSAGE') }}</textarea>
        </div>
