                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <ul class="mt-4">
                                            ...
                                            <li>Event checkout link: <b>%event_checkout_link</b></li>
                                            ...
                                            <li>Company name: <b>%user_company_name%</b></li>
                                            <li>Company phone: <b>%user_company_phone%</b></li>
                                            <li>Company email: <b>%user_company_email%</b></li>
                                            <li>Company website: <b>%user_company_website%</b></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
