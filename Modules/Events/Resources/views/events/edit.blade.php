                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 address-wrapper">
                                    <div class="form-group required">
                                        ...
                                        <input type="text" name="address" value="{{ old('address', $event->address) }}" id="address"
                                            class="form-control" />
                                        @error('address')
                                        <small class="text-danger">{{ $message }}</small>
                                        @enderror
...
@push('scripts')
    ...
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBCZVSjuVPDGigu-jFRtmV6p8fVXtlOxyc&libraries=places&callback=initMap"></script>
    <script>
