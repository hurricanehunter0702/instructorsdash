                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <label class="custom-switch">
                                            @if ($item->is_active)
                                                <input type="checkbox" name="is_active" id="is_active" value="1" class="custom-switch-input" onchange="change()" checked />
                                            @else 
                                                <input type="checkbox" name="is_active" id="is_active" value="0" class="custom-switch-input" onchange="change()" />
                                            @endif
                                ...
                                <div class="col-md-4" id="is_shown_on_header">
                                    <div class="form-group">
                                        <div class="form-label">@lang('Show')</div>
                                        <label class="custom-switch">
                                            @if ($item->is_shown_on_header)
                                                <input type="checkbox" name="is_shown_on_header" value="1" class="custom-switch-input" checked>
                                            @else 
                                                <input type="checkbox" name="is_shown_on_header" value="0" class="custom-switch-input" >
                                            @endif
                                            
                                            <span class="custom-switch-indicator"></span>
                                            <span class="custom-switch-description">@lang('Show on header')</span>
                                        </label>
                                    </div>
                                </div>                                
                            </div>
...
@push('scripts')
<script>
    var isActive = "<?php echo "$item->is_active" ?>";
    if (!isActive) {
        $("#is_shown_on_header").addClass("d-none");
    }
    function change() {
        $("#is_shown_on_header").toggleClass("d-none");
    }
</script>
@endpush