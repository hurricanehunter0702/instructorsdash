  ...
  $(document).on('click', 'a.scroll-to-top', function(e) {
    ...
    var preseOpt = {
        ...
        steps: [{
          ...
          loc: "/accountsettings",
          before: function() {
            $(".card-footer .btn[type='submit']").prop("disabled", true);
          },
          title: "",
          ...
          before: function() {
            ...
            $("#category_table > tbody .btn").prop("disabled", true);
          },
          loc: "/categories",
          ...
          loc: "/events/" + testEventId + "/edit",
          before: function() {
            $("#form_create .card-footer button[type='submit']").prop("disabled", true);
          },
          ...
          loc: "/upsell",
          before: function() {
            $("#upsell_table .delete-btn").prop("disabled", true);
          },
          ...
          loc: `/events/${testEventId}/edit`,
          before: function() {
            $("#form_create .card-footer button").prop("disabled", true);
          },
          ...
          event: "click"
            ...
            delayBefore: 1500,
            before: function() {
              $("#users-table .btn-delete").prop("disabled", true);
            },
            ...
            delayBefore: 1000,
            before: function() {
              $("#modalTransfer .btn[type='submit']").prop("disabled", true);
            },
            ...
            before: function() {
                ...
                $("#users-table_filter input").prop("readonly", true);
            },
            ...
            delayBefore: 500,
            before: function() {
              $("#new_feature_modal button[type='submit']").prop("disabled", true);
            },
    ...
    if (!isAdmin && testEventId && (isFirstLogin === 1 || eventNums === 0) ) {
