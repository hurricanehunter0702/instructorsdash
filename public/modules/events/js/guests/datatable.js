        ...
        columns: [
            ...
            { data: "fullname", name: "fullname" },
            {
                ...
                render: function (data, type, row) {
                    return row.sub_guests.length + 1;;
                }
            },
            ...
            { 
                data: "upsell", 
                render: function (data, type, row) {
                    if (row.upsell_histories.length) {
                        var html = "<ul class='pl-1'>";
                        row.upsell_histories.forEach(function(history, idx) {
                            html += "<li>" + history.upsell.title + " - $" + history.price + "</li>";
                        });
                        html += "</ul>";
                        return html;
                    } else {
